...
<body>
	...
	<div class="container " style="margin-top:30px;">
		<div class="container" >
		  <h2 style="margin-bottom: 25px;">Reports Sent To Referees</h2>
		  ...
		  <table class="table table-striped text-center"  >
		    ...
		    <tbody style="cursor:pointer" ng-app="myReportList" ng-cloak ng-controller="myCtrl">
		      <tr ng-repeat="x in Reports" onclick="send(this)" data-toggle="tooltip" title="Select For More Details" class="tr" id="rateR_{{x.id}}" style="background-color:rgba(0,0,0,.05)">
	...
	<script>
		function send(element){
			...
			var id = info[1];
			window.location.href = "rateReport?id="+id;
		}
	</script>
	<script type="text/javascript" src="<c:url value="/resources/js/GoTo.js"/>"></script>
	<script type="text/javascript" src="<c:url value="/resources/js/OCCSentReports.js"/>"></script>
</body>
</html>