...
<body>
	...
	<div class="container " style="margin-top:30px;">
		<div class="container" >
		  <h2 style="margin-bottom: 25px;">Reports Sent By Authors</h2>
		  ...
		  <table class="table table-striped text-center"  >
		    ...
		    <tbody style="cursor:pointer" ng-app="myReportList" ng-cloak ng-controller="myCtrl">
		      <tr ng-repeat="x in Reports" onclick="send(this)" data-toggle="tooltip" title="Select For More Details" class="tr" style="background-color:rgba(0,0,0,.05)">
	...
	<script type="text/javascript" src="<c:url value="/resources/js/OCCIncomingReports.js"/>"></script>
