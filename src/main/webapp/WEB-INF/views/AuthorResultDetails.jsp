...
<div class="container" style="margin-top:70px">
    ...
    <div class="col-sm-12" style="margin: 0px!important;margin-top: 16px!important;padding: 0px;">
        <div ng-app="myResult" ng-cloak ng-controller="myCtrl" class="w3-card-2 w3-margin" style="max-width:100%;margin-left: 5%px;background-color: #f1f1f1;padding-bottom: 16px;">
            <header class="w3-container w3-light-grey w3-padding-1" style="border-bottom:3px solid grey;margin-bottom: 10px;">
                <h3  >Report's result :  {{Result()}} </h3>
            </header>
            
            <header class="w3-container w3-light-grey w3-padding-1" >
              <h5>Referees And Their Opinions</h5>
            </header>
            <ul class="w3-ul " ng-repeat="x in userOpinion" style="border:1px solid grey;margin: 10px;" >
...
<script src="<c:url value="/resources/js/AuthorResultDetails.js"/>"></script>
</body>
</html>